 ...
 */
export async function generateContent({ prompt, style = 'cinematic', aspectRatio = '16:9', quality = 'balanced', type = 'image', seed, creativity, guidance, negativePrompt }) {
      ...
      videos: [
        {
          ...
          creativity,
          guidance,
          seed: seed ? Number(seed) : Math.floor(Math.random() * 9999999999),
          negativePrompt,
